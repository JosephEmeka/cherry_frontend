            ...
            >
                ...
                <form>
                    ...
                    <div className="text-right mb-4">
                        <a href="#" className="text-xs text-custom-cherry hover:underline">
                            Forgot Password?
                        </a>
                    </div>
                ...
                <p className="mt-3 text-center text-xs">
                    Don’t have an account? <a href="#" className="text-blue-600 font-medium hover:underline">Create an Account</a>
                </p>
            </div>
        </div>
    );
